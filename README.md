...
- ⭐ **三星评分 + 进度记忆**：按步数接近最短路给星，鼓励"想更聪明的解法"；进度存浏览器不丢
- 🔊 **朗读提示**：一键朗读关卡提示，照顾还不识字的孩子
...
- 📲 **可装可离线（PWA）**：手机上"添加到主屏幕"即可像 App 一样全屏打开，断网也能玩
- 🔊 **音效与动画**：走步、撞击、收集、过关撒花，反馈即时
- ✨ **炫酷视觉**：机器人呼吸/弹跳/脚印轨迹、充电动画；四组关卡四主题(草地/沙漠/雪地/太空)+漂浮背景；震屏、三星逐颗弹出等丰富反馈
- 🌍 **中英双语**：自动按浏览器语言显示，可一键切换中 / English
