...
const I18N = {
  zh: {
    ...
    'fn.btn': '🧩 招式',
    'fn.title': '🧩 我的招式',
    'fn.hint': '用方向键编一套动作，存成"招式"，就能在程序里一键反复使用！',
    'fn.empty': '先用下面的方向键编几个动作…',
    'fn.use': '把招式放进程序 →',
    'fn.close': '完成',
    'fn.label': '招式',
    // —— 编辑器提示 ——
  ...
  en: {
    ...
    'fn.btn': '🧩 My Move',
    'fn.title': '🧩 My Move',
    'fn.hint': 'Build a set of actions, save it as a "Move", and reuse it anytime!',
    'fn.empty': 'Build a few actions with the arrows below…',
    'fn.use': 'Add the Move to the program →',
    'fn.close': 'Done',
    'fn.label': 'Move',
