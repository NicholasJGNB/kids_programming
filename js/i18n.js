...
const I18N = {
  zh: {
    ...
    "btn.levelSelect": "🗺 选关",
    // —— 方向/操作按钮 ——
    "btn.up": "上", "btn.down": "下", "btn.left": "左", "btn.right": "右",
    "btn.loop": "🔁 重复",
    "btn.loopEnd": "✓ 结束圈",
    "btn.undo": "↩ 撤回",
    "btn.clear": "🗑 清空",
    ...
    "edit.wall": "障碍", "edit.star": "宝贝", "edit.start": "起点",
    "edit.goal": "电池", "edit.erase": "擦掉",
    "edit.size": "📐 换大小", "edit.clear": "🗑 清空",
    "edit.back": "← 返回", "edit.play": "▶ 开始玩",
    // —— 选关浮层 ——
    "picker.title": "选择关卡",
    "picker.build": "🏗 自己造一关",
    "picker.close": "关闭",
  ...
  en: {
    ...
    "edit.wall": "Wall", "edit.star": "Treasure", "edit.start": "Start",
    "edit.goal": "Battery", "edit.erase": "Erase",
    "edit.size": "📐 Resize", "edit.clear": "🗑 Clear",
    "edit.back": "← Back", "edit.play": "▶ Play",
